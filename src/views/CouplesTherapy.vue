<template>
  <div>
    <article>
      Lucifer and Ariel guarded perches built on soap boxes. Battle lines extended far along the
      broad shoulders of Dr. Rachel as she observed her morning session.<br /><br />
