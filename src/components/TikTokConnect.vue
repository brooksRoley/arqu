<template>
  <div class="relative group w-full">
    ...
    <template v-if="!available">
      <div class="absolute -inset-0.5 bg-gradient-to-r from-cyan-500/20 to-pink-500/20 rounded-xl blur opacity-20 transition duration-500" />
      <div class="relative flex items-center justify-between w-full bg-black border border-gray-800/50 text-gray-500 px-6 py-4 rounded-xl">
        <div class="flex items-center gap-4 z-10">
          ...
          <div class="flex flex-col text-left">
            <span class="font-bold text-sm tracking-wide uppercase text-gray-600">TIKTOK</span>
            <span class="text-xs text-gray-700 font-mono mt-0.5">Expose your algorithm.</span>
          </div>
        </div>
    ...
    <template v-else>
      ...
      <button
        ...
        class="relative flex items-center justify-between w-full bg-black border border-gray-800 text-gray-200 px-6 py-4 rounded-xl shadow-2xl transition-all overflow-hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500"
